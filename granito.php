						...
						<div class="row">
							...
							<div class="col-lg-9 col-sm-6 col-12">
								<div class="theme-title-one">
									<h2>Granito</h2>
									<p style="text-align: left;">Com intuito de melhor acabamento de seu projeto, executamos diversos revestimentos em mármores e granitos.</p>
								</div> <!-- /.theme-title-one -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-sm-6 col-12">
                                        ...
                                        <ul style="padding-top: 40px;list-style: disc;padding-left: 3%;">
                                            <li class="item">Revestimento em piso, paredes, pilares e vigas;</li>
                                            <li class="item">Reparo e fixação de granito em fachadas;</li>
                                            <li class="item">Revestimento de escadas;</li>
                                            <li class="item">Acabamentos internos/ externos como: soleiras, tento box, chapim, peitoril e outros;</li>
                                        </ul>
                                ...
                                <div class="row">
                                    <div class="col-sm-6 col-md-4">
                                        <a class="lightbox" href="images/servicos/granito/1.jpg">
                                            <img src="images/servicos/granito/1.jpg" alt="">
                                        </a>
                                    </div>
                                     <div class="col-sm-6 col-md-4">
                                        <a class="lightbox" href="images/servicos/granito/2.jpg">
                                            <img src="images/servicos/granito/2.jpg" alt="">
                                        </a>
                                    </div>
                                     <div class="col-sm-6 col-md-4">
                                        <a class="lightbox" href="images/servicos/granito/3.jpg">
                                            <img src="images/servicos/granito/3.jpg" alt="">
                                        </a>
                                    </div>
                                     <div class="col-sm-6 col-md-4">
                                        <a class="lightbox" href="images/servicos/granito/4.jpg">
                                            <img src="images/servicos/granito/4.jpg" alt="">
                                        </a>
                                    </div>
                                     <div class="col-sm-6 col-md-4">
                                        <a class="lightbox" href="images/servicos/granito/IMG_3701(1).jpg">
                                            <img src="images/servicos/granito/IMG_3701(1).jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="col-sm-6 col-md-4">
                                        <a class="lightbox" href="images/servicos/granito/IMG_3883.jpg">
                                            <img src="images/servicos/granito/IMG_3883.jpg" alt="">
                                        </a>
                                    </div>
                                </div>
                                    </div>
