...
<html lang="pt-BR">
	...
	<body>
		<div class="main-page-wrapper">
			...
			-->
			<!--
			<div class="bannerInterno" style="background-image: url(images/servicos/projetos.jpg);">
						...
						<div class="row">
							...
							<div class="col-lg-9 col-sm-6 col-12">
								<div class="theme-title-one">
									<h2>Projetos</h2>
									<p style="text-align: left;">Desenvolvemos projetos visando atender as suas necessidades e adequamos o orçamento de acordo com as condições desejadas.</p>
								</div> <!-- /.theme-title-one -->
								<ul style="padding-top: 40px;list-style: disc;padding-left: 3%;">
									<li class="item">Projeto de Arquitetura (legal/executivo)</li>
									<li class="item">Projeto de Estruturas (concreto/metálico)</li>
									<li class="item">Projeto de Instalações (elétrica, especiais, hidráulica, esgoto, gás e incêndio)</li>
									<li class="item">Soluções construtivas</li>
								</ul>
							</div> <!-- /.col- -->
						</div> <!-- /.row -->
					</div> <!-- /.wrapper -->
