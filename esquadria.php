			...
			<div class="our-case section-spacing" style="padding-bottom: 100px;">
				<div class="container">
					<div class="titulo-servicos">
						<h2>Esquadria de Alumínio / Ferro</h2>
					</div> <!-- /.theme-title-one -->
					<div class="wrapper">
						<div class="row">
							...
							<div class="col-lg-9 col-sm-6 col-12">
								<div class="theme-title-one">
									<h2>Esquadria de Alumínio / Ferro</h2>
									<p style="text-align: left;">Com experiência neste ramo, conseguimos atender construtoras e consumidor final independente da demanda.</p>
								</div> <!-- /.theme-title-one -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-sm-6 col-12">
                                        ...
                                        <ul style="padding-top: 40px;list-style: disc;padding-left: 3%;">
                                            <li class="item">Contra marcos;</li>
                                            <li class="item">Guarda corpo e corrimão;</li>
                                            <li class="item">Janelas e Portas;</li>
                                            <li class="item">Telhado;</li>
                                            <li class="item">Portões;</li>
                                            <li class="item">Pele de vidro;</li>
                                            <li class="item">Brise e caixas para ar condicionado;</li>
                                            <li class="item">Outros;</li>
                                        </ul>
