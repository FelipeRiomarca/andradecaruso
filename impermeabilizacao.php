						...
						<div class="row">
							...
							<div class="col-lg-9 col-sm-6 col-12">
								<div class="theme-title-one">
									<h2>Impermeabilização</h2>
									<p style="text-align: left;">A impermeabilização é fundamental para garantir a estabilidade de sistemas estruturais e outros sistemas construtivos. Realizamos diversos tipos de impermeabilizações com altíssima qualidade, em cada caso existe um sistema específico adequado tais com: manta asfáltica, manta líquida, argamassa polimérica entre outras. </p>
								</div> <!-- /.theme-title-one -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-sm-6 col-12">
                                        ...
                                        <ul style="padding-top: 40px;list-style: disc;padding-left: 3%;">
                                            <li class="item">Terraço descoberto;</li>
                                            <li class="item">Telhados e Calhas;</li>
                                            <li class="item">Cisterna e Caixa d’água;</li>
                                            <li class="item">Reservatório de retardo/reuso;</li>
                                            <li class="item">Piscina;</li>
                                            <li class="item">Áreas molhadas internas (cozinhas, áreas de serviço, banheiros, varandas e etc...);</li>
                                        </ul>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 col-md-4">
                                        <a class="lightbox" href="images/servicos/impermeabilizacao/1.jpg">
                                            <img src="images/servicos/impermeabilizacao/1.jpg" alt="">
                                        </a>
                                    </div>
                                     <div class="col-sm-6 col-md-4">
                                        <a class="lightbox" href="images/cases/02/zoom/01.jpg">
                                            <img src="images/cases/02/zoom/01.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="col-sm-6 col-md-4">
                                        <a class="lightbox" href="images/cases/02/zoom/02.jpg">
                                            <img src="images/cases/02/zoom/02.jpg" alt="">
                                        </a>
                                    </div>
                                     <div class="col-sm-6 col-md-4">
                                        <a class="lightbox" href="images/cases/02/zoom/03.jpg">
                                            <img src="images/cases/02/zoom/03.jpg" alt="">
                                        </a>
                                    </div>
