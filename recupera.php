                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-sm-6 col-12">
                                        ...
                                        <ul style="padding-top: 40px;list-style: disc;padding-left: 3%;">
                                            <li class="item">Concreto armado vigas, pilares e lajes;</li>
                                            <li class="item">Estrutura metálica;</li>
                                            <li class="item">Reforço estrutural;</li>
                                            <li class="item">Tratamento em junta de dilatação;</li>
                                        </ul>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 col-md-4">
                                        <a class="lightbox" href="images/cases/05/zoom/02.jpg">
                                            <img src="images/cases/05/zoom/02.jpg" alt="">
                                        </a>
                                    </div>
                                     <div class="col-sm-6 col-md-4">
                                        <a class="lightbox" href="images/cases/05/zoom/01.jpg">
                                            <img src="images/cases/05/zoom/01.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="col-sm-6 col-md-4">
                                        <a class="lightbox" href="images/cases/05/zoom/03.jpg">
                                            <img src="images/cases/05/zoom/03.jpg" alt="">
                                        </a>
                                    </div>
