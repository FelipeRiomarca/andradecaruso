			...
			<div class="our-case section-spacing" style="padding-bottom: 100px;">
				<div class="container">
					<div class="theme-title-one">
						<h2 style="padding-top: 80px;">MISSÃO</h2>
						<p>A Andrade & Caruso tem como objetivo melhoria continua de processos construtivos para atender com alta qualidade, rapidez e baixo custo, às necessidades do mercado atual em relação à construção civil.</p>
					</div> <!-- /.theme-title-one -->
				</div> <!-- /.container -->
			</div> <!-- /.our-case -->
