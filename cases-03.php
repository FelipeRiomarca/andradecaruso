			...
			<div class="our-case section-spacing">
				<div class="container">
					<div class="theme-title-one">
						...
						<p>Barra da Tijuca – RJ | Impermeabilização | Terraço Descoberto/Cisterna</p>
					</div> <!-- /.theme-title-one -->
					<div class="wrapper">
						<div class="row">
			        ...
			        <div class="row">
			            <div class="col-sm-6 col-md-4">
			                <a class="lightbox" href="images/cases/03/zoom/01.jpg">
			                    <img src="images/cases/03/01.jpg" alt="">
			                </a>
			            </div>
			            <div class="col-sm-6 col-md-4">
			                <a class="lightbox" href="images/cases/03/zoom/02.jpg">
			                    <img src="images/cases/03/02.jpg" alt="">
			                </a>
			            </div>
			            <div class="col-sm-12 col-md-4">
			                <a class="lightbox" href="images/cases/03/zoom/03.jpg">
			                    <img src="images/cases/03/03.jpg" alt="">
			                </a>
			            </div>
			            <div class="col-sm-12 col-md-4">
			                <a class="lightbox" href="images/cases/03/zoom/04.jpg">
			                    <img src="images/cases/03/04.jpg" alt="">
			                </a>
			            </div>
			            <div class="col-sm-12 col-md-4">
			                <a class="lightbox" href="images/cases/03/zoom/05.jpg">
			                    <img src="images/cases/03/05.jpg" alt="">
			                </a>
			            </div>
			        </div>
