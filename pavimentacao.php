						...
						<div class="row">
							...
							<div class="col-lg-9 col-sm-6 col-12">
								<div class="theme-title-one">
									<h2>Pavimentação</h2>
									<p style="text-align: left;">Conseguimos atender diversos serviços com relação a pavimentação, veja abaixo alguns de nossos serviços.</p>
								</div> <!-- /.theme-title-one -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-sm-6 col-12">
                                        ...
                                        <ul style="padding-top: 40px;list-style: disc;padding-left: 3%;">
                                            <li class="item">Execução e reforma de pisos para garagem ou passeio como: intertravado, concregrama, pedra portuguesa, piso polido e contrapisos diversos;</li>
                                            <li class="item">Diversos tipos de pintura para piso, incluindo pinturas especiais, epóxi e outros;</li>
                                            <li class="item">Pintura de piso para quadra poliesportiva;</li>
                                            <li class="item">Demarcações vagas de garagem;</li>
                                        </ul>
