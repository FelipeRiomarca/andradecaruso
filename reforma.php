						...
						<div class="row">
							...
							<div class="col-lg-9 col-sm-6 col-12">
								<div class="theme-title-one">
									<h2>Reforma Predial</h2>
									<p style="text-align: left;"> Executamos diversos acabamentos internos, com objetivo de atender todas etapas de reforma.</p>
								</div> <!-- /.theme-title-one -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-sm-6 col-12">
                                        ...
                                        <ul style="padding-top: 40px;list-style: disc;padding-left: 3%;">
                                            <li class="item">Demolições em geral;</li>
                                            <li class="item">Alvenaria bloco cerâmico ou concreto;</li>
                                            <li class="item">Chapisco interno/externo;</li>
                                            <li class="item">Revestimento em argamassa camurçada ou sarrafeada;</li>
                                            <li class="item">Revestimento em gesso convencional ou acartonado (drywall);</li>
                                            <li class="item">Revestimento cerâmico piso/parede;</li>
                                            <li class="item">Revestimento pastilhas;</li>
                                            <li class="item">Pintura com acabamentos diversos;</li>
                                            <li class="item">Textura rolada, espatulada, rustica tipo “grafiatto”;</li>
                                            <li class="item">Contra piso cimento queimado liso, sarrafeado;</li>
                                            <li class="item">Rebaixamento de teto em placa de gesso ou acartonado (drywall);</li>
                                        </ul>
