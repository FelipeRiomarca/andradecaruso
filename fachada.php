						...
						<div class="row">
							...
							<div class="col-lg-9 col-sm-6 col-12">
								<div class="theme-title-one">
									<h2>Reforma de Fachada</h2>
									<p style="text-align: left;">Executamos reforma de fachada de maneira eficiente, removendo todas as impurezas da superfície, recuperando estruturas e revestimentos com produtos específicos antes da pintura. Em se tratando de repintura a preparação da base é fundamental. </p>
								</div> <!-- /.theme-title-one -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-sm-6 col-12">
                                        ...
                                        <ul style="padding-top: 40px;list-style: disc;padding-left: 3%;">
                                            <li class="item">Higienização, Hidrojateamento e Revitalização;</li>
                                            <li class="item">Tratamento de trincas e fissuras;</li>
                                            <li class="item">Recuperação de revestimento (emboço, reboco, pastilhas, textura);</li>
                                            <li class="item">Tratamento de armaduras oxidadas;</li>
                                            <li class="item">Instalações de drenos em fachadas;</li>
                                            <li class="item">Afastamento de chaminés;</li>
                                            <li class="item">Pintura de fachada;</li>
                                        </ul>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 col-md-4">
                                        <a class="lightbox" href="images/cases/04/zoom/01.jpg">
                                            <img src="images/cases/04/zoom/01.jpg" alt="">
                                        </a>
                                    </div>
                                     <div class="col-sm-6 col-md-4">
                                        <a class="lightbox" href="images/cases/04/zoom/02.jpg">
                                            <img src="images/cases/04/zoom/02.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="col-sm-6 col-md-4">
                                        <a class="lightbox" href="images/cases/04/zoom/03.jpg">
                                            <img src="images/cases/04/zoom/03.jpg" alt="">
                                        </a>
                                    </div>
